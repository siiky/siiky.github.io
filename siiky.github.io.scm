(import (prefix ssg |ssg:|))

(define index
  (idx "nothing interesting here"
       (dir "algebra"
	    (ent "./groups.md" "" "A quick intro to Group Theory")
	    (ent "./cat_theory_perf.md" "2019/10/15 22:00" "Category Theory for performance optimization")
	    )
       ...
       (dir "server_stuffs"
	    (ent "./seamless_updates.md" "2020/03/13 23:30" "Seamless Updates")
	    )
       ...
       (dir 'wip "functional_programming"
	    (ent "./immutability.md" "2020/04/10 18:30" "Immutability")
	    )
...
(ssg:ssg
  (ssg:site
    #:css (ssg:css-file "assets/monokai.css")
    #:index index
    )
  )
