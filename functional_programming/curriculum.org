...
Define a function in Haskell that given an ~Int~ doubles it [@code:int_double],
...
Define a function in Haskell that given an ~Int~ squares it [@code:int_square].
...
#+LABEL: @code:int_double
#+NAME: @code:int_double
#+BEGIN_SRC haskell
double :: Int -> Int
double x = 2 * x
#+END_SRC
...
#+LABEL: @code:float_double
#+NAME: @code:float_double
#+BEGIN_SRC haskell
double :: Float -> Float
double x = 2 * x
#+END_SRC
...
#+LABEL: @code:int_square
#+NAME: @code:int_square
#+BEGIN_SRC haskell
square x = x * x
#+END_SRC

#+CAPTION: Squares a given float.
#+LABEL: @code:float_square
#+NAME: @code:float_square
#+BEGIN_SRC haskell
square x = x * x
#+END_SRC
