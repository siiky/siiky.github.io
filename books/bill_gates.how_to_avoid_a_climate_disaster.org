...
not: the /Introduction/ starts on p3, and the /Climate Change and COVID-19/ ends
on p230. Hopefully that will help getting around. For figures and tables you can
...
First off, I didn't like the overall tone and his unquestionably stating that
"progress" is good.
...
This point is related to some of the themes in /Sex at Dawn/ from my point of
view.
...
Some of his statements are not backed by any source, you're supposed (I guess?)
...
(emitted per year, I suppose). The figure includes also the rise of the average
temperature over the years. (fig p24)
...
David Foster Wallace (speech, /This Is Water/) (p38-39).
...
"evolve"? Until 1850 (according to fig p24) we barely made a dent to the
climate. How can you assume that evolving was a good thing? Even agriculture may
have been a mistake (/Sex at Dawn/, again)!
...
| Getting around        |        16% | Cars, planes, trucks, trains, ...              |
| Keeping warm and cool |         7% | Heating & cooling, refrigeration               |
|-----------------------+------------+------------------------------------------------|

Human activities and their percentage of greenhouse gases emitted (tbl p55)
(unfortunately unsourced). He gives a definition of what goes where in a
footnote:
...
"How much power does it take?" -- Gates' cheatsheet on energy quantities. (tbl p57)
...
least material hungry. (tbl p85) The numbers here are approximate, measured with
a ruler.
...
Histogram showing number of deaths per unit of electricity generated. (p87) The
...
(p96) Well, obviously! Finally he says something more sensible:
...
1/6, respectively, of the energy "we put in". (p115) (This is one of the bits
mentioned at the top of the post that have no source stated).

Graph of the trend of meat consumption on some countries over the years, from
2000 to 2020, with predictions until 2028. (fig p116) In 2020, million tons of
meat consumed (approximate numbers, measured with a ruler): Mexico, 9.6; Brazil,
19.2; EU, 40; USA, 42; China, 80. Source: OECD-FAO Agricultural Outlook 2020.
...
Pros of planting mangrove trees (one of the unsourced statements).
(p172-173)
